...
#define CLASSINHTAB "class_inhTab"
...
#define CALLEE_STACK_OFFSET(nts)                                               \
  (CALLEE_SAVED_REGISTERS_COUNT + nts) * WORD_SIZE
#define CALLEE_SAVED_REGISTERS_OFFSET CALLEE_SAVED_REGISTERS_COUNT *WORD_SIZE
